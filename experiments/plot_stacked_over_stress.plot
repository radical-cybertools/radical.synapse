...
do for [term_i=1:words(terms)] {
  ...
  # set mytics 10
    ...
    # --------------------------------------------------------------------------------------------------
    # 
    # The direct mandelbrot profiling and emulation comparison only exists for boskop_3
    #
    set output './'.name.'.'.t 
    print      './'.name.'.'.t
  ...
  # set size 1.0,1.5
    ...
    set xtics  in 0,1,12
    set ytics  in 90000,5000,100000
    set xlabel ''
